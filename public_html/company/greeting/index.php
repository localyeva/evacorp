...
<link rel="stylesheet" href="<?php echo APP_URL; ?>common/css/individual/sub.css?20141201" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo APP_URL; ?>common/css/individual/top.css?20141201" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo APP_URL; ?>common/css/layout.css?20141201" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo APP_URL; ?>common/css/base.css?20141201" type="text/css" media="all" />
<!-- FACE BOOK start -->
...
<div id="container" class="clearfix">
	...
	<div id="mainContent">
		...
		<div class="greetingBox clearfix t0b15"> <img src="<?php echo APP_URL; ?>img/company/greeting/img_photo01.jpg" width="325" height="562" alt="代表 薛　悠司" />
			<div class="descGr">
				<p class="fz16 mb20 ls03">日本の会社が抱える問題点や課題点が、<br />我が社の優秀なベトナム人スタッフ達やサポート体制によって解決し、ビジネスの成長を促進させると確信しています。</p>
