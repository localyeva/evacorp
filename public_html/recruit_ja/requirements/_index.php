...
<div id="container" class="clearfix"> 
  <!-- /container start -->
  <h2 class="taC mb30"><img src="<?php echo APP_URL; ?>img/requirements/h2.png" width="999" height="44" alt=""  /></h2>
  <!-- /mainContent start -->
  <div id="main">
	  ...
	  <li>
        ...
        <div class="SLeft">
          ...
          <div class="SText">
            ...
            <p class="taC"><a href="<?php echo APP_URL ?>contact?job=<?php echo the_title();?>"><img src="../img/requirements/btn01.png" width="199" height="50" class="opa" alt=""  /></a></p>
          </div>
        </div>
      </li>
