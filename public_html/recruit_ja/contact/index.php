...
";
  ...
  $from = "recruitmentjp@evolable.asia";
	$fromname = "Evolable Asia 求人お問い合わせ";
       ...
       $email_info->addTo('ayako@evolable.asia');
       $email_info->addTo('fujikawa@evolable.asia');
       $email_info->addTo('ito@evolable.asia');
       $email_info->addTo('kashiwagi@evolable.asia');
       $email_info->addTo('nagai@evolable.asia');
       $email_info->addTo('nakagawa@evolable.asia');       
       $email_info->addTo('sul@evolable.asia');
       $email_info->addTo('umezawa@evolable.asia');
       $email_info->addTo('y_nakamura@evolable.asia');
...
<script type="text/javascript">
	$(function(){
		...
		var address = "recruitmentjp" + "@" + "evolable.asia";
