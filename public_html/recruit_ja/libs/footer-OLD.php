	...
	<div class="footer_bg">
		<div id="footerInner" class="t10b0 clearfix">
			...
			<ul class="ul_menu2 floatL">
                ...
                <li><span>＋</span><a href="<?php echo APP_URL; ?>faq">よくあるご質問</a></li>
                <li><span>＋</span><a href="<?php echo APP_URL; ?>contact">お問い合せ</a></li>
			</ul>
			<p class="p_top01 floatL"><a  href="http://evolable.asia/" target="_blank"> <img src="<?php echo APP_URL_LINK; ?>img/top/btn_04.png" alt="EVOLABLE ASIA CORPORATE SITE" class="opa" /> </a>
			
			<a href="<?php echo APP_URL; ?>contact"><img src="<?php echo APP_URL_LINK; ?>img/top/btn_05.png" alt="応募フォーム" class="opa" /></a> </p>
			<div class="face">
...
<script type="text/javascript" src="<?php echo APP_URL; ?>common/js/jquery.easing.1.3.js"></script> 
