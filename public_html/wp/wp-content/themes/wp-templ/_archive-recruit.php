...
<div id="container" class="clearfix">
	...
	<div id="mainContent">
        <!-- /mainContent start -->
			...
			<p class="t0b35 taC"><a href="http://evolable.asia/recruit_lp/" target="_blank"><img src="<?php echo APP_URL; ?>common/img/btn/bnr_mikarika02.png" width="705" height="173" alt="" class="opa" /></a></p>

			<p class="t0b35 taC"><a href="http://evolablejobs.talentnetwork.vn/en" target="_blank"><img src="/img/recruit/bnr_recruit01.jpg" width="700" height="92" alt="" class="opa"/></a></p>
			<!--
