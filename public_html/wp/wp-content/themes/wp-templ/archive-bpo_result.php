<?php get_header(); ?>
<title>BPO実績｜BPO（アウトソーシング） ベトナム｜ベトナムでのラボ型オフショア開発、BPOならエボラブルアジア</title>
<meta name="description" content="ベトナムでのオフショア開発、ラボ型オフショア開発、BPOのエボラブルアジアのBPO実績ページです。" />
...
<!-- FACE BOOK start -->
<meta property="og:title" content="BPO実績｜BPO（アウトソーシング） ベトナム｜ベトナムでのラボ型オフショア開発、BPOならエボラブルアジア" />
...
<div id="container" class="clearfix">
	...
	<div id="mainContent">
		...
		<ul id="bread" class="clearfix">
			<li class="home"><a href="<?php echo APP_URL; ?>">TOP</a> </li>
			<li> <a href="<?php echo APP_URL; ?>service/">サービス</a></li>
			<li>開発実績</li>
		</ul>
		<h2 class="t0b35"><img src="<?php echo APP_URL; ?>img/service/bpo_result/h2_resultbpo.jpg" width="770" height="210" alt="BPO実績 BPO RESULTS"/></h2>
		<ul class="ul_result p0b20">
			<?php
				$wp_query = new WP_Query();
				$param=array(
						'post_type'=>'bpo_result',
						'order' => 'DESC',
						'post_status'=>'publish',
						'posts_per_page' => '4',
						'paged' => $paged,
